...
//            Navigator.maybePop(context);
      ...
      actions: getActions(buttonColor, buttonDisabledColor, context),
    );
  }

  List<Widget> getActions(Color buttonColor, Color buttonDisabledColor, BuildContext context){
    // Show an icon if clear is not active, so there's no ripple on tap
    final Widget clearSearchQueryWidget = new IconButton(
